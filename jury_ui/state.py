"""Stage-1 seed data so the UI shows real-looking content on first run.

Mirrors the Example.png screenshot in the source repo, plus the extra
"Both Struck" juror requested.  Drop this file once real load-from-file
...
def populate_sample(api) -> None:
    api.jurors = _SAMPLE
    api.grid = {"rows": 4, "cols": 7, "jury_size": 12, "corner": "TL"}
    api.active_panel = 1
    api.selected_seat = 19      # Christopher White, per Example.png
    api.selected_final = 7      # William Miller
...
_SAMPLE: list[dict[str, Any]] = [
    ...
    {"id": 7,  "name": "William Miller",      "age": 37, "status": "final",       "seat": 7,  "panel": 1,
     "finalNo": 2, "rating": 3, "keywords": "fireman", "notes": "fell asleep during interview"},
    ...
    {"id": 17, "name": "Charles Thomas",      "age": 45, "status": "final",       "seat": 17, "panel": 1,
     "finalNo": 1, "rating": 2},
    {"id": 18, "name": "Nancy Jackson",       "age": 67, "status": "seated",      "seat": 18, "panel": 1},
    {"id": 19, "name": "Christopher White",   "age": 33, "status": "seated",      "seat": 19, "panel": 1,
     "keywords": "trucker"},
    ...
    # Both-struck demo (the new bottom-left pane)
